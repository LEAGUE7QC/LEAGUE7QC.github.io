# Season 4 - Rules & Format

## 1. Introduction

### 1.1 Purpose
LEAGUE7 provides a structured competitive environment for Harry Potter: Quidditch Champions players of all skill levels. Building upon our Season 3, Season 4 continues with division-based structure to enhance competitive balance and provide appropriate challenges for teams of varying skill levels. The season maintains its two-phase format:
...
- Season 4 maintains the existing three-division structure from Season 3
- Divisions will preserve their composition based on Season 3 final standings and N.E.W.T.s promotion/relegation results
...
These Season 4 rules continue the framework established in Season 3. The division-based structure aims to provide appropriate competition levels for teams of varying skills, while the promotion/relegation system creates pathways for advancement. 
